                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center m-auto">
                            <h4 class="text-uppercase text-center">Actualitzar Usuaris</h4>
                        </div>
                        <form action="index.php?controller=usuari&action=actualitzarAction" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="nom" class="form-control" value="<?= $usuari->nom ?>">
                            </div>
                            <div class="form-group mb-3">
                                <label for="fname">COGNOMS</label>
                                <input type="text" name="cognoms" class="form-control" value="<?= $usuari->cognom ?>">
                            </div>
                            <div class="form-group mb-3">
                                <label for="fname">EMAIL</label>
                                <input type="email" name="email" class="form-control" value="<?= $usuari->email ?>">
                            </div>
                            <div class="form-group mb-3">
                                <label for="fname">PASSWORD</label>
                                <input type="password" name="password" class="form-control" value="<?= $usuari->password ?>">
                            </div>
                            <br>
