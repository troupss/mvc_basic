...
<body>
    ...
    <div class="container mt-5">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php while ($usuaris = $tot_els_usuaris->fetch_object()) : ?>
                    <tr>
                        <td><?= $usuaris->id ?></td>
                        <td><?= $usuaris->nom ?></td>
                        <td><?= $usuaris->email ?></td>
                        <td><a href="index.php?controller=usuari&action=actualitzarUsuari&id=<?= $usuaris->id ?>"><button class="btn btn-outline-primary">Actualitzar</button></a></td>
                        <td><a href="index.php?controller=usuari&action=EsborrarUsuari&id=<?= $usuaris->id ?>"><button class="btn btn-outline-primary">Esborrar</button></a></td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
        </table>
        <a href="index.php?controller=usuari&action=crear"><button class="btn btn-outline-primary">Insertar</button></a>
