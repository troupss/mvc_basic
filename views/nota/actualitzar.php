...
<head>
    ...
    <title>Actualitzar</title>
</head>
<?php
    $nota = $notes->fetch_object();
?>
            ...
            <div class="col-md-6 col-lg-4 col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="index.php?controller=nota&action=actualitzarAction" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="titol" class="form-control" value="<?= $nota->titol ?>">
                            </div>
                            <div class="form-group mb-3">
                                <label for="fname">DESCRIPCIO</label>
                                <input type="text" name="descripcio" class="form-control" value="<?= $nota->descripcio ?>">
                            </div>
                            <br>
