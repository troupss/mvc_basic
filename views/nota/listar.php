...
<body>
    ...
    <div class="container mt-5">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php while ($nota = $notes->fetch_object()) : ?>
                    <tr>
                        <td><?= $nota->id ?></td>
                        <td><?= $nota->usuari_id ?></td>
                        <td><?= $nota->titol ?></td>
                        <td><?= $nota->data ?></td>
                        <td><?= $nota->descripcio ?></td>
                        <td><a href="index.php?controller=nota&action=actualitzarNota&id=<?= $nota->id ?>"><button class="btn btn-outline-primary">Actualitzar</button></a></td>
                        <td><a href="index.php?controller=nota&action=EsborrarNota&id=<?= $nota->id ?>"><button class="btn btn-outline-primary">Esborrar</button></a></td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
        </table>
        <a href="index.php?controller=nota&action=crear"><button class="btn btn-outline-primary">Insertar</button></a>
        <!--content end-->
        <!-- JavaScript -->
