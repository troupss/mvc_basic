...
<body>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center m-auto">
                            <h4 class="text-uppercase text-center">Insertar Nota</h4>
                        </div>
                        <form action="index.php?controller=nota&action=insertar" method="post">
                            ...
                            <div class="form-group mb-3">
                                <label for="fname">USUARI ID</label>
                                <input type="text" name="idusuari" placeholder="Introduexi el id del usuari" class="form-control" required="">
                            </div>
                            <div class="form-group mb-3">
                                <label for="fname">TITOL</label>
                                <input type="text" name="titol" placeholder="Introduexi el titol de la nota" class="form-control" required="">
                            </div>
                            <div class="form-group mb-3">
                                <label for="fname">DESCRIPCIO</label>
                                <input type="text" name="descripcio" placeholder="Introduexi la descripcio de la nota" class="form-control" required="">
                            </div>
                            <br>
    ...
    <a href="index.php?controller=nota&action=listar"><button class="btn btn-outline-primary">Tornar</button></a>
    <?php
    ?>
    <!--content end-->
    <!-- JavaScript -->
